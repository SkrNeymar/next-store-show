...
const PlanList = [
  {
    ...
    price: "$19",
    description:
      "Ideal for startups and individual store owners just stepping into e-commerce.",
    href: "https://next-store-admin-neon.vercel.app/",
    features: [
      "Manage up to 2 online stores",
      "Create and manage up to 50 products",
      "Basic API integration for store management",
      "Access to standard sales reporting tools",
      "E-mail support",
    ],
    featured: false,
  },
  {
    ...
    price: "$49",
    description:
      "Perfect for growing businesses looking to expand their online presence.",
    href: "https://next-store-admin-neon.vercel.app/",
    features: [
      "Manage up to 5 online stores",
      "Unlimited product listings",
      "Advanced API integration with custom routes",
      "Enhanced sales and inventory reporting",
      "Priority e-mail and chat support",
      "Access to multi-store dashboard",
    ],
    featured: true,
  },
  {
    ...
    price: "Contact Sales",
    description:
      "A comprehensive solution for large businesses with extensive e-commerce needs.",
    href: "https://next-store-admin-neon.vercel.app/",
    features: [
      "Manage unlimited stores",
      "Advanced product management features",
      "Full API access with custom development support",
      "Comprehensive sales, VAT, and inventory reporting",
