  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <p className="max-w-2xl mx-auto mt-6 text-lg tracking-tight text-slate-700">
        Designed for ease, not just expertise. Manage your store without the
        tech stress.
      </p>

      {/* Hero Button Group */}
      <div className="flex justify-center mt-10 gap-x-6">
        <Button href="https://next-store-front-nine.vercel.app/">
          Get 6 Months Free
        </Button>
        <Button
          href="https://www.linkedin.com/in/grant-cheng-dev/"
          variant="outline"
        >
          <HeroRegSvg />
